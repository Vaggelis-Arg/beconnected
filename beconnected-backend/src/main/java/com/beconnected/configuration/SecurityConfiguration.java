...
import com.beconnected.filter.JwtAuthenticationFilter;
...
public class SecurityConfiguration {
    ...
    public SecurityConfiguration(UserService userService, JwtAuthenticationFilter jwtAuthenticationFilter, CustomLogoutHandler logoutHandler) {
